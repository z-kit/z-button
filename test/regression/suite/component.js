...
test('SFC component - icon', (t) => {
  ...
  const expected = '100%';
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=icon')
    .wait('.z-button')
...
test('SFC component - rounded', (t) => {
  ...
  const expected = '96px';
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=rounded')
    .wait('.z-button')
    .evaluate(() => window.getComputedStyle(document.querySelector('.z-button')).borderRadius)
    .end()
    .then(actual => t.deepEqual(expected, actual, msg));
...
test('SFC component - block', (t) => {
  ...
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=block')
    .wait('.z-button')
    .evaluate(() => {
...
test('SFC component - disabled state', (t) => {
  ...
  const expected = 0;
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=disabled%20state')
    .wait('.z-button')
    .evaluate(() => {
      const buttonStyle = window.getComputedStyle(document.querySelector('.z-button'));
...
test('SFC component - link button', (t) => {
  ...
  const expected = 'a';
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?selectedKind=Stateless%20functional%20component&selectedStory=link')
    .wait('.z-button')
